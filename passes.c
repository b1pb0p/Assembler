...
//    if (is_label(src, first_word)) {
//        if((report = process_label(src, first_word)))
//            return report;
//        if (IS_DATA(next_word)) {
//            process_data(src, first_word, p_line);
